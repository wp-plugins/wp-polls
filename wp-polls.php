...
function poll_header() {	
	...
	wp_register_script('wp-polls', '/wp-content/plugins/wp-polls/polls-js.php', false, '2.22');
...
function poll_header_admin() {
	wp_register_script('wp-polls-admin', '/wp-content/plugins/wp-polls/polls-admin-js.php', false, '2.20');
...
function poll_external_plugins() {	
	echo 'tinyMCE.loadPlugin("polls", "'.get_option('siteurl').'/wp-content/plugins/wp-polls/tinymce/plugins/wp-polls/");' . "\n"; 
	return;
}
