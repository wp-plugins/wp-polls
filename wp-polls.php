...
### Function: Enqueue Polls Stylesheets
add_action('wp_print_styles', 'poll_stylesheets');
function poll_stylesheets() {
...
### Function: Print Polls Stylesheets That Are Dynamic
add_action('wp_head', 'poll_stylesheets_dynamic');
function poll_stylesheets_dynamic() {
	$pollbar = get_option('poll_bar');	
	echo "\n".'<!-- Start Of Style Generated By WP-Polls 2.50 -->'."\n";
	...
	echo '</style>'."\n";
	echo '<!-- End Of Style Generated By WP-Polls 2.50 -->'."\n";
}


### Function: Enqueue Polls JavaScripts
add_action('wp_footer', 'poll_javascripts');
function poll_javascripts() {	
	$poll_ajax_style = get_option('poll_ajax_style');
	$pollbar = get_option('poll_bar');	
	wp_register_script('wp-polls', plugins_url('wp-polls/polls-js.js'), array('jquery'), '2.50');
	...
	echo "\n".'<!-- Start Of Script Generated By WP-Polls 2.50 -->'."\n";
	wp_print_scripts('wp-polls');
	echo '<!-- End Of Script Generated By WP-Polls 2.50 -->'."\n";
}


### Function: Enqueue Polls JavaScripts In WP-Admin
add_action('admin_footer-wp-polls/polls-manager.php', 'poll_javascripts_admin');
add_action('admin_footer-wp-polls/polls-add.php', 'poll_javascripts_admin');
add_action('admin_footer-wp-polls/polls-options.php', 'poll_javascripts_admin');
add_action('admin_footer-wp-polls/polls-templates.php', 'poll_javascripts_admin');
add_action('admin_footer-wp-polls/polls-uninstall.php', 'poll_javascripts_admin');
function poll_javascripts_admin() {
	wp_register_script('wp-polls-admin', plugins_url('wp-polls/polls-admin-js.js'), array('jquery'), '2.50');
	...
	echo "\n".'<!-- Start Of Script Generated By WP-Polls 2.50 -->'."\n";
	wp_print_scripts('wp-polls-admin');
	echo '<!-- End Of Script Generated By WP-Polls 2.50 -->'."\n";
}
