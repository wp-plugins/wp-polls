...
function poll_header() {	
	...
	wp_register_script('wp-polls', '/wp-content/plugins/wp-polls/polls-js-packed.js', false, '2.31');
...
function poll_header_admin() {
	wp_register_script('wp-polls-admin', '/wp-content/plugins/wp-polls/polls-admin-js-packed.js', false, '2.31');
	echo "\n".'<!-- Start Of Script Generated By WP-Polls 2.31 -->'."\n";
	echo '<script type="text/javascript">'."\n";
	echo '/* <![CDATA[ */'."\n";
