...
add_action('wp_head', 'poll_javascripts_header');
function poll_javascripts_header() {
...
function poll_javascripts() {	
	...
	$pollbar = get_option('poll_bar');
	wp_register_script('wp-polls', plugins_url('wp-polls/polls-js.js'), array('jquery'), '2.50', true);
