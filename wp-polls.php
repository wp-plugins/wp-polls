...
function poll_header() {	
	...
	wp_register_script('wp-polls', '/wp-content/plugins/wp-polls/polls-js.php', false, '2.30');
...
function poll_header_admin() {
	wp_register_script('wp-polls-admin', '/wp-content/plugins/wp-polls/polls-admin-js.php', false, '2.30');
