...
function poll_header_admin() {
	...
	echo "\t".'var polls_admin_text_delete_poll = \''.__('Delete Poll', 'wp-polls').'\';'."\n";
	echo "\t".'var polls_admin_text_no_poll_logs = \''.__('No poll logs available.', 'wp-polls').'\';'."\n";
	echo "\t".'var polls_admin_text_delete_all_logs = \''.__('Delete All Logs', 'wp-polls').'\';'."\n";
	echo "\t".'var polls_admin_text_checkbox_delete_all_logs = \''.__('Please check the \\\'Yes\\\' checkbox if you want to delete all logs.', 'wp-polls').'\';'."\n";
	echo "\t".'var polls_admin_text_delete_poll_logs = \''.__('Delete Logs For This Poll Only', 'wp-polls').'\';'."\n";
	echo "\t".'var polls_admin_text_checkbox_delete_poll_logs = \''.__('Please check the \\\'Yes\\\' checkbox if you want to delete all logs for this poll ONLY.', 'wp-polls').'\';'."\n";
	echo "\t".'var polls_admin_text_delete_poll_ans = \''.__('Delete Poll Answer', 'wp-polls').'\';'."\n";
	echo "\t".'var polls_admin_text_open_poll = \''.__('Open Poll', 'wp-polls').'\';'."\n";
	echo "\t".'var polls_admin_text_close_poll = \''.__('Close Poll', 'wp-polls').'\';'."\n";
	echo "\t".'var polls_admin_text_enter_poll_id = \''.__('Enter Poll ID', 'wp-polls').'\';'."\n";
	echo "\t".'var polls_admin_text_enter_poll_id_again = \''.__('Error: Poll ID must be numeric', 'wp-polls').'\n\n'.__('Please enter Poll ID again', 'wp-polls').'\';'."\n";
	echo '/* ]]> */'."\n";
	echo '</script>'."\n";
