...
function poll_header() {	
	echo "\n".'<!-- Start Of Script Generated By WP-Polls 2.15 -->'."\n";
	wp_register_script('wp-polls', '/wp-content/plugins/polls/polls-js.php', false, '2.15');
	...
	echo '</style>'."\n";
	echo '<!-- End Of Script Generated By WP-Polls 2.15 -->'."\n";
}
...
function poll_header_admin() {
	wp_register_script('wp-polls-admin', '/wp-content/plugins/polls/polls-admin-js.php', false, '2.15');
